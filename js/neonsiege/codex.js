      ...
      <div class="codex-section">
        ...
        <div class="codex-grid">
          ...
          <div class="codex-card" style="--card-color:#39ff14">
            ...
            <div class="codex-card-desc">Arena-style maps: path rings wrap void pockets with tower islands inside. Mobs take branches — cover chokepoints with towers. 20–24 build sites. MAZE/CHAOS (ring arenas + forks), FORTRESS (spiral), CORRIDOR (long path), RIFT (3 routes).</div>
          </div>
        </div>
      </div>
      <div class="codex-section">
